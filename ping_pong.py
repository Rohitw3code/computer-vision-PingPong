...
ball = Ball(radius=15, color=(0, 255, 0), step=18, startX=500)
...
wall2 = Wall(posx=700, posy=10, width=35, height=100)
...
while True:
    ...
    img = np.zeros((frameHeight, frameWidth, 3), dtype='uint8')
    ...
    ball.drawText("Player 1 ",(10,20))
    ball.drawText("Player 2",(750,20))

    ball.drawText(f"Score : {ball.score1}",(10,40))
    ball.drawText(f"Score : {ball.score2}",(750,40))
